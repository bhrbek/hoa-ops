...
const SheetHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-2 px-6 py-5 border-b border-slate-200",
      className
    )}
    {...props}
  />
...
const SheetFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse sm:flex-row sm:justify-end gap-3 px-6 py-4 border-t border-slate-200 bg-slate-50",
      className
    )}
    {...props}
  />
